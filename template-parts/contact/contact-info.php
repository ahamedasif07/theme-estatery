<section class="py-24 bg-[#fcfcfc]" id="contact-page">
    <div class="container mx-auto px-6 max-w-7xl">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="text-secondary font-bold uppercase tracking-widest text-[10px] mb-1 opacity-50">
                                Office Address</h4>
                            <p class="text-secondary text-sm font-semibold">Uttara Sector 07, Dhaka - Mymensingh
                                Highway, Bangladesh</p>
                        </div>
                    </div>
        ...
        <div
            class="mt-20 w-full h-[450px] rounded-[2.5rem] overflow-hidden border border-secondary/5 shadow-2xl grayscale transition-all duration-700 hover:grayscale-0">
            <iframe
