...
$subtitle    = get_theme_mod('hero_subtitle', 'Luxury Real Estate Agency');
$title       = get_theme_mod('hero_title', 'Find Your Dream Apartment');
$description = get_theme_mod('hero_description', 'Explore our curated list of luxury properties designed for your ultimate comfort and style.');
$btn_text    = get_theme_mod('hero_btn_text', 'Search Now');
...
<section class="relative min-h-[700px] lg:h-[90vh] flex items-center justify-center overflow-hidden bg-[#0a1d23]">
    ...
    <div class="container mx-auto px-4 relative z-20 text-center text-white">
        ...
        <p class="max-w-2xl mx-auto text-gray-200 text-sm md:text-lg mb-12 leading-relaxed opacity-90">
